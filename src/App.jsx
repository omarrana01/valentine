...
function App() {
  ...
  return (
    <div
      className="min-h-[100svh] flex items-center justify-center px-4 bg-cover bg-center"
    ...
    >
      <div className="relative w-full max-w-md">
        ...
        >
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 text-center border border-white/40 w-full">
        ...
        >
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 text-center border border-white/40 w-full">
            ...
            <div className="flex flex-col items-center gap-4 relative h-40">
              <button
